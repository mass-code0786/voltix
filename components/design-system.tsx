  ...
  return (
    <header className="sticky top-0 z-30 h-[72px] bg-[#060a08]/72 px-5 backdrop-blur-2xl lg:border-b lg:border-white/[.06]">
      <div className="mx-auto flex h-[72px] max-w-[420px] items-center justify-between gap-3 lg:max-w-6xl">
        <div className="flex h-16 w-fit shrink-0 items-center justify-start">
          <img src="/logo.png" alt="VOLTIX" className="block h-[60px] w-auto max-w-none object-contain opacity-100 mix-blend-normal filter-none transform-none" />
        </div>
